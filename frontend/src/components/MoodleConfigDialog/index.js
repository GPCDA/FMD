...
import {
  ...
  DialogInput, DialogSpan, selectStyle,
} from '../../styles/global';
...
class MoodleConfigDialog extends Component {
  ...
  submit = () => {
    ...
    this.props.putLms({
      id, url, token, version: version.value,
    });
    ...
    return (
      <Dialog>
        <DialogForm>
          ...
          <DialogInput value={url} autoComplete="off" onChange={this.handleChangeInput} name="url" />
