...
import {
  LeftContent, SelectContainer, Content, Separator,
} from './styles';
...
class Dashboard extends Component {
  ...
  render() {
    ...
    const loading = false;
    const {
      course, subject, semester, phenomenon,
    } = this.props;
    const {
      courseSelected, subjectSelected, semesterSelected, phenomenonSelected,
        ...
        <ConfigContainer size="big" style={{ color: '#000' }}>
          ...
          <Content>
            ...
            <LeftContent>
              ...
              <Button onClick={() => { /* Nothing */ }}>Gerar Análise</Button>
...
const mapStateToProps = ({
  course, indicator, subject, semester, phenomenon,
}) => ({
  course, indicator, subject, semester, phenomenon,
});
